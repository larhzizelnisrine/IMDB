...
def plot_scatter(data):
    """This function creates a scatter plot using the data."""
    fig = px.scatter(data, x="TotalCases", y="TotalDeaths", hover_data=["Continent"])
    return fig
...
def plot_histogram(data):
    """This function creates a histogram using the data."""
    fig = px.histogram(data, x="TotalTests", nbins=10)
    return fig

def plot_pie(data):
    """This function creates a pie chart using the data."""
    fig = go.Figure(data=go.Pie(labels=data['Continent'], values=data['TotalCases']))
    return fig
...
app.layout = html.Div([
    ...
    html.Div([
        html.Br(),
        html.H2("Scatter Plot", style={"text-align": "center"}),
        html.Br(),
        dcc.Graph(id="scatter_plot", figure=plot_scatter(data))
    ]),

    html.Div([
        html.Br(),
        html.H2("Histogram", style={"text-align": "center"}),
        html.Br(),
        dcc.Graph(id="histogram", figure=plot_histogram(data))
    ]),
    ...
    html.Div([
        ...
        html.Br(),
        dcc.Graph(id="pie_chart", figure=plot_pie(data))
    ]),
])
